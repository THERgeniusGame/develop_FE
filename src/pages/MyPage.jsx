      ...
      <ProfileImg>
        <MypageContainer>
          ...
          <div className="body">
            ...
            <Btns onClick={() => { setModal(true); }} style={{ float: "right", marginRight: "225px", marginTop: "50px" }}>회원탈퇴</Btns>
          </div>
        </MypageContainer>
      </ProfileImg>
      {modal === true ?
        <div>
          <SignoutModal onSubmit={(e) => { submitHandle(e); }} type="button" onClick={() => {
            ...
            <SignoutModalBody onClick={(event) => { event.stopPropagation() }} >
              ...
              <div>
                <Btns style={{ margin: "0 20px" }}>회원탈퇴</Btns>
                <Btns style={{ margin: "0 20px" }} type="button" onClick={() => { setModal(!modal) }}>돌아가기</Btns>
              </div>
            </SignoutModalBody>
          </SignoutModal>
        </div> : ''}
